...
def _simulate(root, tt, policy_model, q1_model, q2_model, goal,
              c_puct, value_norm, dead_end_value, oracle, w1_norm, w1_beta, w1_n0, w1_lambda, w1_ramp_topk, w1_ramp_uniform):
...
def _search(root_state, root_key, policy_model, q1_model, q2_model, goal,
            ...
            stop_on_first_solution, oracle, w1_beta, w1_n0, w1_lambda, w1_ramp_topk, w1_ramp_uniform):
...
def _main(args):
    ...
    print(f"[config] ramp boost: w1_beta={args.w1_beta} w1_n0={args.w1_n0} w1_lambda={args.w1_lambda} topk={args.w1_ramp_topk} uniform={args.w1_ramp_uniform} c_puct={args.c_puct}", flush=True)
