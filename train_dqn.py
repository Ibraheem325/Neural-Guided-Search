...
def _save_checkpoint(model: rgnn.RelationalGraphNeuralNetwork, optimizer: torch.optim.Optimizer, path: Path | str) -> None:
    model.save(path, {'optimizer': optimizer.state_dict()})
