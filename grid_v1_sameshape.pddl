(define (problem grid-v1-sameshape)
(:domain grid)
(:objects 
...
(:init
(arm-empty)
(place f0-0f)(place f1-0f)(place f2-0f)(place f3-0f)(place f4-0f)(place f5-0f)(place f6-0f)(place f7-0f)
...
(conn f3-0f f4-0f)(conn f4-0f f3-0f)(conn f4-0f f5-0f)(conn f5-0f f4-0f)(conn f5-0f f6-0f)(conn f6-0f f5-0f)
(conn f6-0f f7-0f)(conn f7-0f f6-0f)
(open f0-0f)(open f1-0f)(open f2-0f)(open f3-0f)(open f4-0f)(open f5-0f)
(locked f6-0f)(locked f7-0f)
(lock-shape f6-0f shape3)(lock-shape f7-0f shape3)
(at keyA f5-0f)(at keyB f5-0f)(at keyC f5-0f)(at keyD f5-0f)(at keyE f5-0f)(at keyF f5-0f)(at keyG f5-0f)(at keyH f5-0f)
(at-robot f0-0f)
)
(:goal (and (at keyD f7-0f)))
)
