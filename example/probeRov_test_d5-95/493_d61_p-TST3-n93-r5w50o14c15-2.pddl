(define (problem prb-493_d61_p-TST3-n93-r5w50o14c15-2) (:domain Rover)
(:objects
	general - Lander
...
(full rover4store)
(calibrated camera8 rover4)
(have_image rover4 objective12 high_res)
(at rover2 waypoint39)
(have_soil_analysis rover4 waypoint19)
)
