...
(define (problem roverprob2312)
  (:domain rover)
  (:objects general colour high_res low_res rover0 rover1 rover0store rover1store waypoint0 waypoint1 waypoint2 waypoint3 waypoint4 waypoint5 camera0 camera1 camera2 objective0 objective1)
  (:init
