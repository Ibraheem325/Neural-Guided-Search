...
(define (problem roverprob1423)
  (:domain rover)
  (:objects general colour high_res low_res rover0 rover1 rover2 rover3 rover0store rover1store rover2store rover3store waypoint0 waypoint1 waypoint2 waypoint3 waypoint4 waypoint5 camera0 camera1 camera2 camera3 objective0 objective1 objective2)
  (:init
