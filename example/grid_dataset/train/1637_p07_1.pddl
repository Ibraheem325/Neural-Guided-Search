...
(define (problem roverprob4123)
  (:domain rover)
  (:objects general colour high_res low_res rover0 rover1 rover2 rover0store rover1store rover2store waypoint0 waypoint1 waypoint2 waypoint3 waypoint4 waypoint5 camera0 camera1 objective0 objective1)
  (:init
