(define (problem prb-086_d07_p-VAL3-n58-r2w30o11c9-1) (:domain Rover)
(:objects
	general - Lander
...
(full rover1store)
(have_rock_analysis rover1 waypoint13)
(have_image rover1 objective3 colour)
(have_image rover1 objective5 high_res)
(have_rock_analysis rover1 waypoint17)
(have_image rover1 objective6 low_res)
(have_rock_analysis rover1 waypoint9)
(at rover1 waypoint20)
(have_rock_analysis rover1 waypoint26)
)
