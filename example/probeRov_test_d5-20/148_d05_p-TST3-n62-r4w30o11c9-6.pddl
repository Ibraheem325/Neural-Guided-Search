(define (problem prb-148_d05_p-TST3-n62-r4w30o11c9-6) (:domain Rover)
(:objects
	general - Lander
...
(have_rock_analysis rover2 waypoint23)
(full rover1store)
(have_image rover1 objective4 high_res)
(at rover1 waypoint26)
(have_soil_analysis rover1 waypoint26)
(have_soil_analysis rover1 waypoint8)
(have_soil_analysis rover3 waypoint23)
(have_rock_analysis rover2 waypoint25)
