(define (problem prob)
 ...
 (:objects 
      shaker1 - shaker
      left right - hand
      shot1 shot2 shot3 shot4 shot5 shot6 shot7 shot8 shot9 shot10 shot11 shot12 shot13 shot14 shot15 shot16 shot17 shot18 shot19 - shot
 ...
 (:goal
  (and
      ...
      (contains shot9 ingredient4)
      (contains shot10 ingredient10)
      (contains shot11 cocktail1)
      (contains shot12 ingredient1)
      (contains shot13 ingredient5)
      (contains shot14 cocktail2)
      (contains shot15 ingredient10)
      (contains shot16 cocktail5)
      (contains shot17 ingredient2)
      (contains shot18 ingredient6)
)))
