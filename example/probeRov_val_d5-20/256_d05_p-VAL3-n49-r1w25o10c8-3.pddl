(define (problem prb-256_d05_p-VAL3-n49-r1w25o10c8-3) (:domain Rover)
(:objects
	general - Lander
...
(have_image rover0 objective8 colour)
(have_soil_analysis rover0 waypoint21)
(have_rock_analysis rover0 waypoint4)
(have_rock_analysis rover0 waypoint16)
