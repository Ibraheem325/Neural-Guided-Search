(define (problem grid-x12-y12-t5-k66666-l66666-p50)
(:domain grid)
(:objects 
        ...
        key0-0 key0-1 key0-2 key0-3 key0-4 key0-5 
        key1-0 key1-1 key1-2 key1-3 key1-4 key1-5 
        key2-0 key2-1 key2-2 key2-3 key2-4 key2-5 
        key3-0 key3-1 key3-2 key3-3 key3-4 key3-5 
...
(open f10-11f)
(locked f7-4f)
(lock-shape f7-4f shape0)
(locked f2-5f)
(lock-shape f2-5f shape0)
(locked f6-5f)
(lock-shape f6-5f shape0)
(locked f11-7f)
(lock-shape f11-7f shape0)
(locked f11-11f)
(lock-shape f11-11f shape0)
(locked f11-5f)
(lock-shape f11-5f shape0)
(locked f0-9f)
(lock-shape f0-9f shape1)
(locked f8-1f)
(lock-shape f8-1f shape1)
(locked f0-10f)
(lock-shape f0-10f shape1)
(locked f11-0f)
...
(locked f1-11f)
(lock-shape f1-11f shape3)
(locked f9-1f)
(lock-shape f9-1f shape3)
(locked f4-10f)
(lock-shape f4-10f shape3)
(locked f0-3f)
(lock-shape f0-3f shape4)
(locked f2-0f)
(lock-shape f2-0f shape4)
(locked f11-1f)
(lock-shape f11-1f shape4)
(locked f5-1f)
(lock-shape f5-1f shape4)
(locked f9-9f)
(lock-shape f9-9f shape4)
(locked f8-2f)
